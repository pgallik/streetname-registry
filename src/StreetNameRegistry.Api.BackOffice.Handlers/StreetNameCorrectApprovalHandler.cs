namespace StreetNameRegistry.Api.BackOffice.Handlers
{
    ...
    public class StreetNameCorrectApprovalHandler : BusHandler, IRequestHandler<StreetNameCorrectApprovalRequest, ETagResponse>
    {
        private readonly BackOfficeContext _backOfficeContext;
        private readonly IMunicipalities _municipalities;
        private readonly IdempotencyContext _idempotencyContext;

        public StreetNameCorrectApprovalHandler(
        ...
        public async Task<ETagResponse> Handle(StreetNameCorrectApprovalRequest request, CancellationToken cancellationToken)
        {
            ...
            var command = new CorrectStreetNameApproval(municipalityId, persistentLocalId, CreateFakeProvenance());
