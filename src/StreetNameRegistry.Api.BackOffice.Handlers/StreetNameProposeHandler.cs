namespace StreetNameRegistry.Api.BackOffice.Handlers
{
    ...
    public class StreetNameProposeHandler : BusHandler, IRequestHandler<StreetNameProposeRequest, PersistentLocalIdETagResponse>
    {
        ...
        public StreetNameProposeHandler(
