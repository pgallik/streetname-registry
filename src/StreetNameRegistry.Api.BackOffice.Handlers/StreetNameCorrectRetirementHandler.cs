namespace StreetNameRegistry.Api.BackOffice.Handlers
{
    ...
    public class StreetNameCorrectRetirementHandler : BusHandler, IRequestHandler<StreetNameCorrectRetirementRequest, ETagResponse>
    {
        private readonly BackOfficeContext _backOfficeContext;
        private readonly IMunicipalities _municipalities;
        private readonly IdempotencyContext _idempotencyContext;

        public StreetNameCorrectRetirementHandler(
        ...
        public async Task<ETagResponse> Handle(StreetNameCorrectRetirementRequest request, CancellationToken cancellationToken)
        {
            ...
            var command = new CorrectStreetNameRetirement(municipalityId, persistentLocalId, CreateFakeProvenance());
