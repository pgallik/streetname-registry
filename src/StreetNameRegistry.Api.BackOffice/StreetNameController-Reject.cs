            ...
            CancellationToken cancellationToken = default)
        {
            ...
            catch (DomainException exception)
            {
                throw exception switch
                {
                    ...
                    StreetNameStatusPreventsRejectionException => new ApiException("Deze actie is enkel toegestaan op straatnaam met status 'voorgesteld'.", StatusCodes.Status409Conflict),
