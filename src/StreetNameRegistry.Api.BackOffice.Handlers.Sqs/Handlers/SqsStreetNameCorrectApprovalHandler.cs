namespace StreetNameRegistry.Api.BackOffice.Handlers.Sqs.Handlers
{
    ...
    public sealed class SqsStreetNameCorrectApprovalHandler : SqsHandler<SqsStreetNameCorrectApprovalRequest>
    {
        public const string Action = "CorrectStreetNameApproval";

        private readonly BackOfficeContext _backOfficeContext;

        public SqsStreetNameCorrectApprovalHandler(
            ISqsQueue sqsQueue,
        ...
        protected override string? WithAggregateId(SqsStreetNameCorrectApprovalRequest request)
        {
        ...
        protected override IDictionary<string, string> WithTicketMetadata(string aggregateId, SqsStreetNameCorrectApprovalRequest sqsRequest)
        {
