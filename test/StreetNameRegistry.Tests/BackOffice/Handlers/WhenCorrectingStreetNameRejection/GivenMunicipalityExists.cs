namespace StreetNameRegistry.Tests.BackOffice.Handlers.WhenCorrectingStreetNameRejection
{
    using System;
    ...
    public sealed class GivenMunicipalityExists : BackOfficeHandlerTest
    {
        ...
        public async Task ThenStreetNameRejectionWasCorrected()
        {
            ...
            var handler = new StreetNameCorrectRejectionHandler(
            ...
            //Act
            var response = await handler.Handle(new StreetNameCorrectRejectionRequest
            {
