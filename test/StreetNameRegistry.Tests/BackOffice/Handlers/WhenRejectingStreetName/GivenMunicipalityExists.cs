namespace StreetNameRegistry.Tests.BackOffice.Handlers.WhenRejectingStreetName
{
    using System;
    ...
    public class GivenMunicipalityExists : BackOfficeHandlerTest
    {
        ...
        public async Task ThenStreetNameWasRejected()
        {
            ...
            var handler = new StreetNameRejectHandler(
            ...
            //Act
            var response = await handler.Handle(new StreetNameRejectRequest
            {
