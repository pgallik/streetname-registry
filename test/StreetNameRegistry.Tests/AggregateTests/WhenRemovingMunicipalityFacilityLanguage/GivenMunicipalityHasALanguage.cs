    ...
    public class GivenMunicipalityHasAFacilityLanguage : StreetNameRegistryTest
    {
        ...
        public void ThenFacilityLanguageWasRemoved(Language language)
        {
            ...
            Assert(new Scenario()
                ...
                .Then(new[]
                {
                    new Fact(_municipalityId, new MunicipalityFacilityLanguageWasRemoved(_municipalityId, language))
                }));
        }
        ...
        public void AndHasMultipleLanguages_TheCorrectOneWasRemoved()
        {
            ...
            Assert(new Scenario()
                ...
                .Then(new[]
                {
                    new Fact(_municipalityId, new MunicipalityFacilityLanguageWasRemoved(_municipalityId, Language.English))
                }));
        }
    }
